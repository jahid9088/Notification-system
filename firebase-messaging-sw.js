...
messaging.onBackgroundMessage(function(payload){
  ...
  const link = payload.data?.link || "https://jahid9088.github.io/Notification-system/";
...
self.addEventListener("notificationclick", function(event){
  ...
  const link = event.notification.data?.link || "https://jahid9088.github.io/Notification-system/";
